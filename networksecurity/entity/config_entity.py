...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TraningPipelineConfig):
        ...
        self.train_model_file_path:str  = os.path.join(self.model_trainer_dir,traning_pipeline.MODEL_TRAINER_TRAINED_DIR_NAME,traning_pipeline.MODEL_TRAINER_TRAINED_MODEL_NAME)
        self.expected_accuracy:float = traning_pipeline.MODEL_TRAINER_EXPECTED_SCORE

import os ,sys 
from networksecurity.entity.artifact_entity import ModelTrainerArtifacts, ClassificationMetricArtifacts, DataTransformationArtifacts
from networksecurity.entity.config_entity import ModelTrainerConfig
from networksecurity.utils.main_utils.utils import save_object,load_object,load_numy_array_data,evaluate_models
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        try:
            ...
            preprocessor = load_object(self.data_transformation_artifacts.transformed_obect_file_path)
            ...
            save_object(self.model_trainer_config.train_model_file_path,object=network_model)

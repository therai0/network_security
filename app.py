...
if __name__ == "__main__":
    try:
        ...
        # initation of data  transformation
        ...
        # initation of model traning
        logging.info("Initation of model trainng")
        model_traning_config = ModelTrainerConfig(
            training_pipeline_config=training_pipeline_config
        )
        model_trainer = ModelTrainer(
            model_trainer_config=model_traning_config,
            data_transformation_artifacts=data_transformation_artifacts,
        )
        model_trainer_artifacts = model_trainer.initiate_model_trianer()
